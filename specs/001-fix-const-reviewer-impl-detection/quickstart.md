...
3. Confirm `extensions/preflight/extension.yml` **and** `presets/preflight/preset.yml` versions were already bumped in lock-step during Phase 1 per CONST-PROC-01 + CLAUDE.md (see plan.md Constitution Check and research.md § 6).
