...
1. If `.specify/memory/constitution.md` exists and is not the doc being reviewed, add it. This is preflight's canonical constitution path when installed as a spec-kit extension (per ADR-007 — path reconciliation with spec-kit).
